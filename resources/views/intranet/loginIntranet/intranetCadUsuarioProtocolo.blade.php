...
{{--                                <button class="menu-toggle">Primary Menu</button>--}}
    ...
    <form style="width: 60%; margin-top: 30px" class="offset-2" method="post" action="/sel/protocolo/msgcadsucess">
        {{-- CSRF--}}
        {{csrf_field()}}
        ...
        <div style="margin-top: 15px; position: relative; text-align: center">
            <a href="/sel/protocolo/msgcadsucess"><button type="submit" class="btn btn-sm btn-primary" style="width: 60%">Cadastrar</button></a>
        </div>
