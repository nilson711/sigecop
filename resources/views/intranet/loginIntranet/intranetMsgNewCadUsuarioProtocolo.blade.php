...
{{--        <h1><span><img src="https://findicons.com/files/icons/1609/ose_png/256/tick.png" width="60px"></img></span>Usuário cadastrado com sucesso!</h1>--}}
        <h2><span><img src="/sel_files/checked_green.gif" width="90px"></img></span>Usuário cadastrado com sucesso!</h2>
        <p class="lead">Você receberá por e-mail uma nova senha para acesso.</p>
        <small>Secretaria de Estado de Esporte e Lazer.</small>
        <hr class="my-4">
        <a class="btn btn-primary btn-sm" href="/sel/protocolo/user" role="button" style="width: 30%">OK</a>
    </div>
