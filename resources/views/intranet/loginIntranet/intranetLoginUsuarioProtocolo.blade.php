        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-9" style="padding-top: 20px">
                    <h1>INTRANET - Protocolo SELDF</h1>
                </div>
...
{{--                                <button class="menu-toggle">Primary Menu</button>--}}
    ...
    <form style="width: 60%; margin-top: 30px" class="offset-2" method="post" action="/intranet/inicio">
        {{-- CSRF--}}
        {{csrf_field()}}
        ...
        <div style="text-align: center">
            <a href="/intranet/inicio"><button type="submit" class="btn btn-primary btn-sm" style="width: 60%">Entrar</button></a>
        </div>
