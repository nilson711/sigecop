...
<div class="topo-titulo-site">
    ...
    <form style="width: 60%; margin-top: 30px" class="offset-2" method="post" action="/sel/protocolo/passwordsent">
        {{-- CSRF--}}
        {{csrf_field()}}
        ...
        <div style="text-align: center">
            <a href="/sel/protocolo/passwordsent"><button type="submit" class="btn btn-primary btn-sm" style="width: 60%">Solicitar Nova Senha</button></a>
        </div>
