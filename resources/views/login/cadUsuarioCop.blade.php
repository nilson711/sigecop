...
<html lang="pt-BR"><!--<![endif]--><head>
    ...
    <link href="/cop_files/bootstrap.css" rel="stylesheet" type="text/css">
    <link href="/cop_files/icomoon.css" rel="stylesheet" type="text/css">
    <link href="/cop_files/style.css" rel="stylesheet" type="text/css">
    <link href="/cop_files/style(1).css" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/css/bootstrap.min.css" integrity="sha384-9aIt2nRpC12Uk9gS9baDl411NQApFmC26EwAOH8WgZl5MYYxFfc+NcPb1dKGj7Sk" crossorigin="anonymous">
    <script async="" src="/cop_files/analytics.js.download"></script><script src="/cop_files/jquery.js.download" type="text/javascript"></script>
    <script src="/cop_files/bootstrap.js.download" type="text/javascript"></script>
    <script type="text/javascript" src="/cop_files/cdn.min.js.download"></script>
    ...
    </script><script src="/cop_files/wp-emoji-release.min.js.download" type="text/javascript" defer=""></script>
    <style type="text/css">
        img.wp-smiley,
        img.emoji {
    ...
    <link rel="stylesheet" id="wp-block-library-css" href="/cop_files/style.min.css" type="text/css" media="all">
...
<div class="menu-para-movel">
    <nav class="navbar navbar-default">
        <div class="container-fluid">
            <img src="/cop_files/cabecalhoSEL.jpg" alt="some text" width=100%">
            <img src="/cop_files/ico-logo-olimpic.svg" alt="some text" width=30% align="center" >
            <h3>SIGECOP - Cadastro</h3>
        </div>
    </nav>
</div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-3">
                    <img src="/cop_files/ico-logo-olimpic.svg" alt="Governo do Distrito Federal" style="height:100px">
                </div>
                <div class="col-md-9" style="padding-top: 20px">
                    <h1>SIGECOP - Cadastro</h1>
                </div>
...
{{--                                <button class="menu-toggle">Primary Menu</button>--}}
    ...
    <div class="col-md-12" style="text-align: center; padding-top: 10px">
        <h3>Usuário</h3>
        <p>Preencha os campos e confira a informações.</p>
    </div>
    <form style="width: 60%; margin-top: 30px" class="offset-2" method="post" action="/cop/login/msgcadsucess">
        {{-- CSRF--}}
        {{csrf_field()}}
        ...
        <div class="row">
            <div class="col-md-4">
                ...
                <input type="text" class="form-control" id="rgUser" name="rgUser" placeholder="RG e órgão expedidor">
            </div>
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <label>Celular</label>
                <input type="tel" id="celUsuario" name="celUsuario" class="form-control cel" placeholder="contato / whatsApp" required>
            </div>
        </div><br>
        <div class="row">
            <div class="col-md-12">
                <label for="copUser">CENTRO OLÍMPICO</label>
                <select class="form-control" id="copUser" name="copUser" title="Local onde o usuário está lotado.">
                    <option disabled selected>Selecione o COP</option>
                    <option>COPSAM - Centro Olímpico da Samambaia</option>
                    <option>COPPLAN - Centro Olímpico de Planaltina</option>
                    <option>COPSANTA - Centro Olímpico de Santa Maria</option>
                    <option>COPSOB - Centro Olímpico de Sobradinho</option>
                    <option>COPRF - Centro Olímpico do Riacho Fundo</option>
                </select>
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 15px">
            ...
            <div class="col-sm-6">
                <label for="confirmaEmailUsuario">Cornfirmação de Email</label>
                <input type="email" class="form-control" id="confirmaEmailUsuario" name="confirmaEmailUsuario" placeholder="confirme o email" onblur="testarEmail()" required>
            </div>
        </div>

        <div style="margin-top: 15px; position: relative; text-align: center">
            <a href="/cop/login/msgcadsucess"><button type="submit" class="btn btn-sm btn-primary" style="width: 60%">Cadastrar</button></a>
        </div>
...
<script>
    ...
    function testarEmail(){
        // console.log($('#emailUsuario').val())
        email = $('#emailUsuario').val()
        confemail = $('#confirmaEmailUsuario').val()
    ...
    function checkRequired() {
        ...
        if($('#confirmaEmailUsuario').val() == ''){
            alert('Confirme o email. ');
            $('#aceiteRegulamento').attr('checked', false)
            $('#confirmaEmailUsuario').focus()
            return false
        }
...
<footer>
    <hr>
    <div class="offset-2">
        <small>Em caso de dúvida, envie um e-mail para getec@esporte.df.gov.br</small>
    </div>
    <br>
