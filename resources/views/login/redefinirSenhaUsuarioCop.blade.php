...
<div class="topo-titulo-site">
    ...
    <div class="col-md-12" style="text-align: center; padding-top: 10px">
        ...
        <p>Digite o endereço de e-mail que uma nova senha será enviada para você.</p>
    </div>
    <form style="width: 60%; margin-top: 30px" class="offset-2" method="post" action="/cop/login/passwordsent">
        {{-- CSRF--}}
        {{csrf_field()}}
        <div class="form-group">
            <label for="loginUser">E-mail cadastrado</label>
        ...
        <div style="text-align: center">
            <a href="/cop/login/passwordsent"><button type="submit" class="btn btn-primary btn-sm" style="width: 60%">Solicitar Nova Senha</button></a>
        </div>
...
<footer>
    <hr>
    <div class="offset-2">
        <small>Se o problema persistir, envie um e-mail para getec@esporte.df.gov.br</small>
