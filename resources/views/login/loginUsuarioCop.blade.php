        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-sm-3">
                    <a href="http://www.brasilia.df.gov.br/" target="_blank"><img src="/cop_files/ico-logo-olimpic.svg" alt="Governo do Distrito Federal" style="height:100px"></a>
                </div>
    ...
    <form style="width: 60%; margin-top: 30px" class="offset-2" method="post" action="/cop/inicial">
        ...
        <div class="form-group">
            ...
            <div style="text-align: right">
                <a href="/cop/login/newpassword">Esqueci a senha</a>
            </div>
        </div>
        <div class="form-group">
            <label for="copUser">CENTRO OLÍMPICO</label>
            <select class="form-control" id="copUser" name="copUser">
        ...
        <div style="text-align: center">
            <a href="/cop/inicial"><button type="submit" class="btn btn-primary btn-sm" style="width: 60%">Entrar</button></a>
        </div>
...
<footer>
    <hr>
    <div class="offset-2">
        <a href="/cop/login/userCad">Não tem senha? Cadastre-se</a>
    </div>
    <br>
